...
<html lang="en">
  ...
  <body>
    ...
    <h1 style='margin:5px; padding:10px; color:white'>Choose a drink brand to see more details</h1>
    <b style='margin:5px; padding:10px; color:white'>Select a drinks brand name: </b>
